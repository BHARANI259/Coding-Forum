...
@RestController
@RequestMapping("/api/faculty/events/{eventId}/problem-statements")
@PreAuthorize("hasRole('FACULTY')")
public class FacultyProblemStatementController {

    private final EventProblemStatementService service;

    public FacultyProblemStatementController(EventProblemStatementService service) {
