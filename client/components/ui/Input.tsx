  ...
  return (
    <label className="block" htmlFor={inputId}>
      ...
      <input
        id={inputId}
        className={cn(
          "mt-2 w-full rounded-lg border border-kec-border bg-white px-3 py-2.5 text-base text-kec-text outline-none transition placeholder:text-kec-muted focus:border-kec-purple focus:ring-4 focus:ring-kec-purple/15 sm:text-sm",
