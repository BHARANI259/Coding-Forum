...
export default function ChangePasswordPage() {
  ...
  return (
    <main className="min-h-dvh overflow-x-hidden bg-kec-bg px-4 py-6 sm:px-6 lg:py-10">
      <section className="mx-auto flex min-h-[calc(100dvh-5rem)] max-w-xl items-center">
